...
class Enemy {
    ...
    pos: number;
    damages: number;
    constructor(name: string, health: number, speed: number, damages: number) {
        this.type = name;
        this.health = health;
        this.speed = speed;
        this.pos = 0;
...
function enemyGenerator(player1: Player, player2: Player) {
...
function enemyLoop (player1: Player, player2: Player) {
